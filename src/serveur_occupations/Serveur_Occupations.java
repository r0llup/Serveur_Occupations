...
/**
 * Manage a {@link Serveur_Occupations}
 * @author Sh1fT
 */
public class Serveur_Occupations extends JDialog {
    private ProtocolRLP protocolRLP;
    ...
    /**
     * Create a new {@link Serveur_Occupations} instance
     * @param parent
     * @param modal 
     */
    public Serveur_Occupations(Frame parent, boolean modal) {
        super(parent, modal);
        this.initComponents();
        this.setProtocolRLP(new ProtocolRLP(this));
        ...
        this.setPropertiesLauncher(new PropertiesLauncher(
                ...
                System.getProperty("file.separator") + "Serveur_Occupations.properties"));
    ...
    public String encryptClientName(String clientName) {
        try {
            ...
            this.getProtocolRLP().getBdbam().stop();
            System.exit(1);
        }
        return null;
    }
    ...
    public ProtocolRLP getProtocolRLP() {
        return protocolRLP;
    }

    public void setProtocolRLP(ProtocolRLP protocolRLP) {
        this.protocolRLP = protocolRLP;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                Serveur_Occupations dialog = new Serveur_Occupations(new javax.swing.JFrame(), true);
